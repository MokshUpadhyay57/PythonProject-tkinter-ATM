...
def Transfer():
    ...
    if(row>0):
        ...
        a.execute("update icicibank set amount=amount+'"+str(amnt)+"' where account='"+ac+"' and ifsc='"+code+"' ")
        conn.commit()
...
# Transfer Button
Button_1 = Button(body, text="Transfer Fund",font=('arial',12,'bold'), width=12,bd=5,height=1,padx=4,pady=5,relief="raised",command=Transfer)
